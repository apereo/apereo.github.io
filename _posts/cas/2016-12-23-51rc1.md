...
Additional CAS properties are exposes for all authentication handlers so
...
CAS ciphers that deal signing/encryption based on JWEs are now by default configured
