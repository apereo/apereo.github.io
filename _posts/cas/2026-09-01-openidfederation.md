...
summary:    Learn how to use CAS as a trust anchor and a federated OP with a pac4j client
tags:       [CAS]
---

As CAS v8.1.0 will support the three roles of the OpenID federation protocol: trust anchor, intermediate and OP, this is the perfect opportunity to present a live demo.

The setup consists of three components:
- a client, referred to as the Relying Party (RP) in OIDC, implemented with pac4j
- a server, referred to as the OpenID Provider (OP) in OIDC, implemented with the CAS server
- a Trust Anchor (TA), also implemented with the CAS server, responsible for establishing trust between the other two components.
...
<img alt="pac4j home page" src="https://www.pac4j.org/img/blog/2026_10/pac4j_before.png" />
...
<img alt="CAS login page" src="https://www.pac4j.org/img/blog/2026_10/cas_login.jpg" />

and we validate the authorizations:

<img alt="CAS authorization page" src="https://www.pac4j.org/img/blog/2026_10/cas_authorize.jpg" />

And it works:

<img alt="pac4j authenticated page" src="https://www.pac4j.org/img/blog/2026_10/pac4j_after.jpg" />

We are finally logged in to the pac4j application thanks to the OpenID Federation protocol and the two CAS server nodes.

> So the CAS server can now act as a federated OP and as a trust anchor <i>with</i> the pac4j RP client.

[Jerome LELEU](https://www.casinthecloud.com/index-en.html)
