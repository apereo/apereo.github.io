...
For component that tightly integrate with AWS such as [Cloud Directory Authentication](https://apereo.github.io/cas/development/installation/AWS-CloudDirectory-Authentication.html) or [CloudWatch](https://apereo.github.io/cas/development/installation/Logging-Cloudwatch.html), CAS is now given the ability to fetch credentials from a variety of sources as part of an ordered chain. Sources include system properties, environment variables, EC2 instance metadata, etc. 
