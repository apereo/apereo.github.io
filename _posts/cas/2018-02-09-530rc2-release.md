...
- [SAML2 Attribtue Friendly Names](#saml2-attribtue-friendly-names)
- [Configuration Binding Behvior](#configuration-binding-behvior)
- [Database DDL via Command-line Shell](#database-ddl-via-command-line-shell)
...
## SAML2 Attribtue Friendly Names

CAS [acting as a SAML2 identity provider](https://apereo.github.io/cas/development/installation/Configuring-SAML2-Authentication.html) is given the ability to individually configure friendly names for attribtues released to service providers.

## Configuration Binding Behvior
...
<div class="alert alert-info">
  <strong>Beware</strong><br/>This is done to ensure configuration settings recognized by CAS are kept up-to-date, accurate and relevant throughout upgrades. As yet another reminder, it is unnecessary to copy a entire collection of CAS settings and values into property sources without fully knowing their application and impact. Per the usual recommendation, you are to keep the entire overlay construct clean, precise  and laser-focused on behavior you do in fact need.
</div>

## Database DDL via Command-line Shell

The [CAS command-line shell](https://apereo.github.io/cas/development/installation/Configuring-Commandline-Shell.html) is now given the ability to export database schemas and DDLs via a new `generate-ddl` command.
