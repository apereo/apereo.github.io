...
[A new REST endpoint](https://apereo.github.io/cas/development/protocol/REST-Protocol.html#authenticate-credentials) is now exposes that is tasked to only verify the validity of the provided credentials without dealing with the ticket API. 
