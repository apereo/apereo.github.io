...
Webflow definitions for multifactor authentication provides (i.e Google Authenticator, Authy, etc) are now constructed dynamically at runtime via webflow auto-configuration rather than static XML definitions. This allows for better flexibility as well as test coverage when it comes to customizations.
