...
[SAML2 Metadata](https://apereo.github.io/cas/development/installation/Configuring-SAML2-DynamicMetadata.html) artifacts can now be fetched and pulled from Git repositories. This capability support both service provider and identity provider artifacts.
...
- When working with Git intgrations, username and email attributes used for commit operations are now resolved via local, global and system configuration before falling back onto default values.
