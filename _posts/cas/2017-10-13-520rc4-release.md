...
20. Thanks to [@NgSekLong](https://github.com/NgSekLong), the signature block type produced in a SAML2 response is now controllable via settings to encode signatures in `PEM` or `DER` mode.
