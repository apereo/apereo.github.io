...
- Thanks to [@bsandiford](https://github.com/bsandiford), memcached serialization via Kryo now takes into account a few more ticket expiration policies and is also set to issue a warning if and when unregistered classes in the kryo registry are found.
