...
- X509 authentication should correctly route the user back to othe login form in cases of authentication failures.
- Google authenticator backed by JDBC should properly create and name databasse tables.
- Minor fixes to OpenID Connect moduile to ensure scopes can properly be filtered, and that clients are fully loaded and management via the services management web application.
