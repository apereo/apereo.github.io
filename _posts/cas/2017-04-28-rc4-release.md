...
A few more [SAML2 service providers](https://apereo.github.io/cas/development/integration/Configuring-SAML-SP-Integrations.html) are added to this release namely Adobe Cloud, AcademicWorks, Infinite Campus and more.

## Surrogate Authentiction

The ability to authenticate on behalf of another user, so called [Surrogate Authentication](https://apereo.github.io/cas/development/installation/Database-Authentication.html), is now included
in this release.
