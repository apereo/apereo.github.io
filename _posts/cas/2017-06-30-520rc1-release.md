...
The ability to issue [JWTs as service tickets](https://apereo.github.io/cas/development/installation/Configure-ServiceTicket-JWT.html#configuration) is now refactored and moved into its own dedicated module such that it can be then become reusable as pluggable extension point in other parts of the codebase. If you had this feature turned on, you may need to adjust the module definition slightly to stay on course with the coolness.

## Swivel Secure Authentication

CAS can now take advantage of Swivel Secure's image-based multifactor authentication. See [this guide](https://apereo.github.io/cas/development/installation/FIDO-U2F-Authentication.html) to learn more.
