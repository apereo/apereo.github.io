...
- [Attribute Repository Merging](#attribute-repository-merging)
- [0.25. Library Upgrades](#025-library-upgrades)
- [0.26. What's Next?](#026-whats-next)
- [0.27. Get Involved](#027-get-involved)
- [0.28. Das Ende](#028-das-ende)
...
## Attribute Repository Merging

Attribute retrieved during the authentication phase are now given the ability to be merged with attributes retrieved from separate attribute repository sources. This behavior previously was only available to select authentication strategies and is now globally applied to all.


## 0.25. Library Upgrades
