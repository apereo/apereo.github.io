...
The official CAS `5.1.0` GA was released on [May 27th 2016](https://github.com/apereo/cas/releases/tag/v5.1.0). Since then,
...
- Performance improvements to ensure serevice selection stragtegies are sorted at the runntime.
