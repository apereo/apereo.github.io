...
There also also changes in place to protect against a few other variations of [this issue](https://apereo.github.io/2026/08/18/vuln/). These fixes apply to the CAS server as a whole and are not connected to a particular feature or extension module.
