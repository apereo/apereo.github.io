...
- Thanks to [@tsschmidt](https://github.com/tsschmidt), loading cas coniguration properties is now made conditional.
...
Thanks to [@dima767](https://github.com/dima767), OAuth2 and OpenID Connect interactions (requests and responses) with CAS are now sent to the audit log.
