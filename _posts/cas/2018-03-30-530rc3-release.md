...
Impersonation features of CAS gain access to a Groovy option to execute [authorization rules for surogate authentication](https://apereo.github.io/cas/development/installation/Surrogate-Authentication.html#surrogate-access-strategy).
