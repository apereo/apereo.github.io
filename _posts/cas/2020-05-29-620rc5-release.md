...
The CAS build and continious integration environment has now moved off of Travis CI and onto GitHub actions. The new environment is much more flexible in terms of available hardware resources, number of concurrent jobs and the general configuration and syntax when it comes caching, different versions of JDKs, etc.
