...
This is the **initial** [Apereo CAS project vulnerability disclosure](https://apereo.github.io/cas/developer/Sec-Vuln-Response.html), which describes a security vulnerability that mainly affects how the CAS server accepts and processes UI. Additional details will be provided once the [security grace window](https://apereo.github.io/cas/developer/Sec-Vuln-Response.html) passes.
