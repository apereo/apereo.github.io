...
Additionally, surrogate account storage and querying can now be done via a REST resource as well. 

See [this guide](https://apereo.github.io/cas/development/installation/Surrogate-Authentication.html) for more info.
