...
- [Memcached Ticket Registry Performance](#memcached-ticket-registry-performance)
...
## Memcached Ticket Registry Performance

The memcached ticket registry has long carried the behavior enforce blocking synchronous ticket CRUD operations. In this release candidate, the registry switches to a more asynchronous model to gain maximum performance. Additional work is planned to ensure connections to memcached can be pooled.
