...
The Hazelcast Ticket Registry is [reorganized a bit](https://github.com/apereo/cas/pull/2361) to improve its performance, by splitting the underlying cache in half. Additional work is done to ensure the registry is prepped to handle additional forms of tickets.
