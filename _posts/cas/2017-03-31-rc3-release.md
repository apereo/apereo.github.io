...
- [Spring Cloud Configuration Server *<sup>[1]</sup>*](#spring-cloud-configuration-server-sup1sup)
- [DynamoDb Ticket Registry](#dynamodb-ticket-registry)
- [CAS Heroku Demos](#cas-heroku-demos)
- [Attribute Repositories & Attributes *<sup>[1]</sup>*](#attribute-repositories--attributes-sup1sup)
...
## Spring Cloud Configuration Server *<sup>[1]</sup>*
...
* [1] This may be a breaking configuration change. Please consult the [CAS docs](https://apereo.github.io/cas/development/) to learn more.
