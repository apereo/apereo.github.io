...
OAuth device flow is [now supported](https://apereo.github.io/cas/development/installation/OAuth-OpenId-Authentication.html). To learn more about the specification, [this tutorial](https://alexbilbie.com/2016/04/oauth-2-device-flow-grant/) should be helpful.
