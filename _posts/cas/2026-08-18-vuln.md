...
This is the *initial* [Apereo CAS project vulnerability disclosure](https://apereo.github.io/cas/developer/Sec-Vuln-Response.html), which describes a security vulnerability that affects how the CAS server manages application authentication requests.
...
The issue is not tied to a specific feature of the CAS software and is an [Open Redirect](https://owasp.org/www-community/attacks/open_redirect) type of vulnerability. You are affected by this security vulnerability if you simply run CAS. Additional details will be published once the security grace window has passed.
