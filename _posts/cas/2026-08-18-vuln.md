...
This is an [Apereo CAS project vulnerability disclosure](https://apereo.github.io/cas/developer/Sec-Vuln-Response.html), which describes a security vulnerability that affects how the CAS server manages application authentication requests.
...
The issue is not tied to a specific feature of the CAS software and is an [Open Redirect](https://owasp.org/www-community/attacks/open_redirect) type of vulnerability. You are affected by this security vulnerability if you simply run CAS. 
...
The issue was originally reported to the CAS project on August 16th, 2026 and fixed on August 17th, 2026. The reporter decided to remain anonymous. Thank you anyway!

# Patching

Patch releases were published on August 17th, 2026. Upgrades to the next patch version for each release should be a drop-in replacement.
...
Modify your CAS overlay to point to the version `7.3.8.1`.

### 8.0.x

Modify your CAS overlay to point to the version `8.0.1.1`.
