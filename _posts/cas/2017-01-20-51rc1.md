---
layout:     post
title:      CAS 5.1 RC1 Release
summary:    ...in which I present an overview of CAS 5.1 RC1 release.
---
...
update that is tagged as `5.1.0`. This post intends to highlight some of the improvements
...
# Multiple Duo Security Configuration <sup>[1]</sup>
...
noted by the above id. However, additional providers can be registered
...
# Multiple Attribute Repositories
...
# Deprecated Hazelcast Configuration
...
Apache Cassandra, which as a pending pull request
...
[1] This is a breaking configuration please. Please consult the [CAS docs](https://apereo.github.io/cas/development/) to learn more.
