...
instance requires Tomcat `v8.5.6` or above. 

## Internet2 Grouper MFA Trigger

As an extra option, CAS can now integrate with [Grouper](http://www.internet2.edu/grouper/software.html) and use a subject [CAS principal] groups' to learn whether MFA should be triggered. As an example, you could devise a use case
