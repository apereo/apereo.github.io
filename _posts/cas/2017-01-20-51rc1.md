...
Bug fix; Improper construction of password encoders caused MongoDb authentication attempts
to all reject user credentials, failing to apply proper hashing/encoding on the password for validation.
...
to the way CAS saves, updates and locates services internally. 
