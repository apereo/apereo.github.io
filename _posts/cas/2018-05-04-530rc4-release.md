...
- [AWS Simple Notification Services for SMS](#aws-simple-notification-services-for-sms)
...
## AWS Simple Notification Services for SMS

Support is now included to take advantage of [Amazon SNS](https://apereo.github.io/cas/development/installation/SMS-Messaging-Configuration.html) for sending SMS messages.
