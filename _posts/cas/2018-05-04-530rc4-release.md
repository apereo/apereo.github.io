...
- [Shake Well Before Use](#shake-well-before-use)
    ...
    - [Gradle](#gradle)
- [Minors](#minors)
- [ADFS Delegated Authentication & MFA](#adfs-delegated-authentication-&-mfa)
...
## ADFS Delegated Authentication & MFA

[Delegating authentication events to ADFS](https://apereo.github.io/cas/development/integration/ADFS-Integration.html) is now revisited to handle multifactor authentication flows better, once the flow travels back from ADFS to CAS after authentication.
